...
export default function Atividade({ data, id, moduleId }) {
...
const Aula = ({ id, exerciceId, index, data }) => {
...
const Canva = ({ id, exerciceId, index, data }) => {
...
const Text = ({ id, exerciceId, index, data }) => {
  const { register, handleSubmit, watch, reset } = useForm();
