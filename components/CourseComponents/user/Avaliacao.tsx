...
<<<<<<< HEAD
      <p className="my-5 text-slate-800 whitespace-pre-line  leading-7">
        ...
        Leia atentamente os enunciados e escolha uma resposta para cada questão.
        Após escolher uma alternativa de uma questão, aperte o botão "Enviar"
        para que essa questão seja respondida. Ao terminar de responder as
        questões, aperte o botão "Finalizar Minha Avaliação" no fim da página.{' '}
        <br />
        Você precisará obter um aproveitamento mínimo de 70% nas questões para
        aprovação. <br />
        Caso você obtenha pelo menos 70% de acertos, será gerado automaticamente
        um Certificado de Conclusão, que estará disponível na sua página de
        Certificados. <br />
        Se você não alcançar a pontuação necessária para a obtenção do
        Certificado, você poderá fazer uma nova avaliação. Você poderá realizar
        tantas tentativas quanto precisar. <br />
        Boa avaliação!
      </p>
...
=======
      {evaluationCompleted ? (
        <button className="bg-gray-400 text-white w-fit px-4 py-2 rounded font-semibold">
          Avaliação Concluída
>>>>>>> cb9f7d9f0d05e0b4e3941f7a75a616ea25156419
        </button>
      ) : (
        <>
          <p className="my-5 text-slate-800 whitespace-pre-line leading-7">
