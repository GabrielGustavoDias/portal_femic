        ...
        <div className="details-it">
          ...
          {project.etica.involve_human.check == 's' && (
            <div className="ml-4 flex flex-col">
              <span className="sub-label">
                Seu projeto pode ser considerado uma pesquisa de opinião, na
                qual dados pessoais dos participantes (Ex: nome, idade,
                endereço, posses ou qualquer dado que identifique a pessoa) não
                são coletados e/ou divulgados:{' '}
              ...
              <span className="sub-label">
                ...
                documento impresso ou virtual (Ex: Termo de Consentimento Livre
                e Esclarecido - TCLE; Termo de Assentimento - TA):{' '}
              ...
              <div className="ml-4 flex flex-col">
                <span className="sub-label">
                  ...
                  pesquisadores que não constituam riscos aos participantes por
                  não haver a experimentação por ingestão ou uso tópico:
                  {project.etica.involve_human['05'].box1 ? 'Sim' : 'Não'}
                </span>
                <span className="sub-label">
                  Teste de produtos ou conceitos desenvolvidos pelos
                  pesquisadores que não constituam riscos aos participantes por
                  não haver a análise de comportamento humano em grupos
                  considerados vulneráveis:{' '}
                  {project.etica.involve_human['05'].box2 ? 'Sim' : 'Não'}
                </span>
                <span className="sub-label">
                  Estudo de estatísticas de acesso público em bancos de dados
                  (ex. estatísticas de jogos, índice de crimes, etc.) desde que
                  não requeira interação com as pessoas das quais os dados foram
                  coletados:{' '}
                  {project.etica.involve_human['05'].box3 ? 'Sim' : 'Não'}
                </span>
                <span className="sub-label">
                  Estudos de análise de comportamento em espaços públicos, desde
                  que os pesquisadores não interajam com os indivíduos
                  estudados, não manipulem o ambiente e não registrem
          ...
          {project.etica.involve_quimic.check == 's' && (
            <div className="flex flex-col ml-4">
              ...
              <span className="sub-label">
                ...
                Informe, ainda, os equipamentos de segurança utilizados, caso se
                aplique: <br />
                {project.etica.involve_quimic.ult_subs}
              </span>
              <span className="sub-label">
                Como foi descartada a substância química ou seus rejeitos:{' '}
                <br /> Acondicionamento em recipiente fechado e transporte para
