...
type IProps = {
 ...
 const ProjectsList: NextPage<IProps> = ({ profile, projects }) => {
  ...
  const createProjectOri = (modality: string) => {
  ...
  const viewProject = (id: string, status: string) => {
    if (status == 'finalista') {
      // return;
    }
  ...
  const navigateToProject = (id: string, status: string) => {
    sessionStorage.setItem('project_id', id);
    router.push('/projetos/time');
  };

  const navigateToConfirmProject = (id: string, finalized: boolean) => {
    if (finalized == true) {
  ...
  const getCertificate = (proj: IProject, win: boolean) => {
  ...
  const renderProjectEdit = (proj: IProject) => {
    return (
      <ProjectInfo>
        <Project>
          <div className="head">
  ...
  const renderProjectRascunho = (proj: IProject) => {
    return (
      <ProjectInfo>
        <Project>
          <div className="head">
  ...
  const renderProjectFinalized = (proj: IProject) => {
    return (
      <ProjectInfo>
        <Project>
          <div className="head">
  ...
  const renderProjectConfirm = (proj: IProject) => {
    return (
      <ProjectInfo>
        <Project>
          <div className="head">
  ...
  const renderProjectConfirmado = (proj: IProject) => {
    return (
      <ProjectInfo>
        <Project>
          <div className="head">
  ...
  const renderProjectConcluido = (proj: IProject) => {
    return (
      <ProjectInfo>
        <Project>
          <div className="head">
