...
export default function SideBar() {
   ...
   useEffect(() => {
     ...
     if(router.asPath.split('/')[router.asPath.split('/').length -1] == 'feiraperfil') {
   ...
   return (
      <ContainerBase color={color}>
         <Link href="/home/feira" passHref>
            <NavGroup style={active == 'home'? {backgroundColor: '#54545460'}:{}}>
               <FiClipboard size={24} color="#fff" />
               <Label>Projetos</Label>
            </NavGroup>
         </Link>
         <Link href="/historico/feira" passHref>
            <NavGroup style={active == 'historico'? {backgroundColor: '#54545460'}:{}}>
               <FiFolder size={24} color="#fff" />
               <Label>Histórico</Label>
            </NavGroup>
         </Link>
         <Link href="/feiraperfil" passHref>
            <NavGroup style={active == 'feiraperfil'? {backgroundColor: '#54545460'}:{}}>
