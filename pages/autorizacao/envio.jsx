...
export default function EnvioTermo() {
  ...
  const sendNewTerms = () => {
    ...
    api
      ...
      .catch((err) => {
        alert(
          'Você deve inserir arquivo no formato PDF e no tamanho de até 2 MB'
        );
        console.warn(err);
      });
  };
  ...
  return (
    <ContainerAutorizationSend>
      ...
      <h1>
        TERMO DE AUTORIZAÇÃO PARA CRIANÇAS E ADOLESCENTES FEMIC – FEIRA MINEIRA
      ...
      {termos.document_ref && (
        <div className="backup">
          ...
          <span className="label">
            Aguardando conferência pela coordenação da FEMIC. Prazo de até 2
            dias uteis.
          </span>
        </div>
      )}
