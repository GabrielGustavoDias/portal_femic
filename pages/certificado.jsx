...
export default function Certificado() {
  ...
  return (
    <div className="w-full h-full">
      <NavBar />
      <ContainerCertificate>
        <h2 className="text-2xl text-green-500 text-bold mt-5">
          AUTENTICAÇÃO DE CERTIFICADOS
        </h2>
        <h3>
          Digite o código de validação que aparece no certificado para conferir
          autenticidade.
        </h3>
      ...
      {err && (
        <ContainerProject>
          ...
          <span>
            Este código não corresponde a nem um dos nossos certificados :(
          </span>
        </ContainerProject>
      )}
    </div>
