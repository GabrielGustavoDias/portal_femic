  ...
  return (
    <LayoutBase title="Desativar conta">
      <div className="px-5">
        ...
        <h2 className="mb-4">
          Ao desativar sua conta ela ficará oculta até você reativá-la novamente
          fazendo login.
        </h2>

        <form
          onSubmit={desativeAcount}
          ...
          <span>
            ...
            participação, certificados e autorizações ficarão ocultos até você
            reativar sua conta fazendo login novamente.
          </span>
          <button
            className="text-white py-4 px-6 rounded bg-yellow-400"
            type="submit">
            Desativar conta
          </button>
        </form>
