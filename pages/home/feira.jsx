    ...
    api
      ...
      .then((res) => {
        ...
        api
          .post(
            '/project/ids',
            res.data.projects.map((pro) => pro.project)
          )
          .then((res2) => {
    ...
    if (credentials == 0) {
      if (initial) {
        return (
          <div className="flex flex-col pl-5">
            <span>
              ...
              Em até 5 dias úteis, a comissão organizadora da FEMIC fará análise
              do seu pedido de afiliação.
              <br /> Mais informações em:{' '}
              <a
                target="_blank"
                rel="noreferrer"
                href="https://femic.com.br/feiras-afiliadas/">
                clique aqui
              </a>
            </span>
          </div>
        ...
        return (
          <div className="flex flex-col pl-5">
            <span>
              Infelizmente sua feira não conquistou credenciais para o ano
              vigente.
            </span>
            <span>
              Informe-se:{' '}
              <a href="https://femic.com.br/feiras-afiliadas/">clique aqui</a>
            </span>
          </div>
        );
      }
      ...
      return (
        <div className="flex flex-col pl-5">
          <span>
            Sua feira possui 1 credencial para a FEMIC neste ano. Já usadas:{' '}
            {rest}
          </span>
      ...
      return (
        <div className="flex flex-col pl-5">
          <span>
            Sua feira possui {credentials} credenciais para a FEMIC neste ano.
            Já usadas: {rest}
          </span>
          <span>Projetos aguardando confirmação</span>
        </div>
        ...
        projects.map((proj) => (
          <ProjectInfo style={{ marginBottom: 20 }} key={proj._id}>
            <Project>
              <div className="head">
                <img
                  src={`https://apiportal.femic.com.br/project/logo/${proj._id}`}
                  alt="Logo"
                />
              </div>
