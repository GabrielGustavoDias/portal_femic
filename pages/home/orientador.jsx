...
export default function Orientador() {
  ...
  const handleProjecEntrain = (project) => {
  ...
  const createNewProject = (modality) => {
        ...
        <Modal.Body>
          <div className="flex flex-col items-center">
            <span className="text-center mb-2">
              Caso você queira criar um projeto para uma equipe de juniors ou
              jovens, clique no canto superior direito da tela e troque seu
              perfil para orientador
            </span>
            <Image
              src="/toca_perfil.gif"
              width={250}
                ...
                return (
                  <ProjectInfo key={project._id}>
                    ...
                    <div className="infos-project">
                      ...
                      <button onClick={() => viewProject(project._id)}>
                        ver projeto
                      </button>
                    </div>
                  </ProjectInfo>
                ...
                return (
                  <ProjectInfo key={project._id}>
                    <Project>
                      ...
                      <button
                        className="button"
                        onClick={() => handleProjecEntrain(project)}>
                        Rascunho
                      </button>
                    </Project>
                    <div className="infos-project">
