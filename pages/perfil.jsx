    ...
    <LayoutBase title="Perfil">
      ...
      <UpdateProfileForm onSubmit={handleSubmit(updateProfile)}>
        ...
        <SelectMult
          ...
          defaultValue={formationTypes.filter((e) =>
          ...
          onChange={(e) =>
            setValue('formation', e.map((it) => it.label).join())
          }
        />
        ...
        {watch('especial') == 's' && (
          <>
            ...
            <SelectMult
              placeholder="Selecione"
              defaultValue={defsTypes.filter((e) =>
              ...
              onChange={(e) =>
                setValue('especial_type', e.map((it) => it.label).join())
              }
            />
          </>
        )}
        ...
        {watch('fluent') && (
          <SelectMult
            placeholder="Selecione"
            defaultValue={idiomasTypes.filter((e) =>
            ...
            onChange={(e) => setValue('fluent', e.map((it) => it.label).join())}
          />
        )}
        <button
          type="submit"
