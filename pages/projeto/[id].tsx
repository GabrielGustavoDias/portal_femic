...
export default function Projeto({ project }: IProjetoView) {
	const [team, setTeam] = useState({
		team: [{}],
		advisors: [{}],
	});

	function extractVideoCodeFromUrl(url: string) {
		...
		<>
			...
			<ContainerProject style={{ marginTop: 75 }}>
				...
				<iframe
					width="50%"
					height="350px"
					onLoad={(e) => (e.currentTarget.style.height = e.currentTarget.scrollHeight + 'px')}
					src={'https://youtube.com/embed/' + extractVideoCodeFromUrl(project.link_yt)}
					title={project.title}
					frameBorder={0}
