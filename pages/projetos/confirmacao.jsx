    ...
    <LayoutBase title="Confirmação de participação">
      <Form onSubmit={handleSubmit(sendConfirm)}>
        ...
        <div className="flex flex-col">
          ...
          <span className="sub-label">
            Para apresentação do projeto em redes sociais, mídias e canais de
            comunicação da FEMIC e parceiros. Deverá ter entre 100 e 500
        ...
        <div className="flex flex-col">
          ...
          <span className="sub-label">
            O vídeo deverá estar no modo público.{' '}
          </span>
          <span className="sub-label">
        ...
        <div className="flex flex-col">
          ...
          <span className="sub-label">
            Tamanho máximo: 2 MB. | Tipo de arquivo permitido: .pdf
          </span>
          <span className="sub-label">
        ...
        <div className="flex flex-col">
          ...
          <input
            type="file"
            onChange={(e) => setValue('relatorio', e.target.files[0])}
            accept=".pdf"
            required
          />
        </div>
