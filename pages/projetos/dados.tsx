...
export default function ProjetoDados() {
	...
	const updateProjectDados = (data: any) => {
		setDisabled(true);
		...
		<LayoutBase title="Dados do projeto">
			<Form onSubmit={handleSubmit(updateProjectDados)}>
				<div className="flex flex-col">
					...
					<span className="sub-label">Mínimo de 25 e máximo de 120 caracteres com espaço.</span>
					<input type="text" {...register('title')} required maxLength={120} minLength={25} />
				</div>
				...
				<div className="flex flex-col">
					...
					<textarea maxLength={2000} minLength={1500} {...register('resume')}></textarea>
				</div>
				<div className="flex flex-col">
					<label htmlFor="">Palavras-chaves</label>
					<span className="sub-label">Separe com vírgulas.</span>
					<input type="text" placeholder="palavra1, palavra2" {...register('keywords_string')} />
				</div>
				<div className="flex flex-col">
					<label htmlFor="">Objetivo geral do projeto</label>
					<span className="sub-label">Máximo de 300 caracteres com espaço.</span>
					<textarea maxLength={300} {...register('general_objective')}></textarea>
				</div>
				<div className="flex flex-col">
					<label htmlFor="">Objetivos específicos do projeto</label>
					<span className="sub-label">Máximo de 1000 caracteres com espaço.</span>
					<textarea maxLength={1000} {...register('especific_objectives')}></textarea>
				</div>
				<label htmlFor="">O projeto é continuidade de ano(s) anterior(es)?</label>
				...
				<label htmlFor="">O projeto possui credencial de alguma Feira Afiliada à FEMIC?</label>
				...
				<Tooltip
					...
					content={
						<p>
							Trata-se de uma imagem que ficará na capa do estande virtual do projeto.
							<br /> Deve ser uma imagem que represente o projeto e/ou a equipe de autores
						</p>
					}>
					<label className="underline">Envie uma foto para a capa do seu projeto*</label>
				</Tooltip>
