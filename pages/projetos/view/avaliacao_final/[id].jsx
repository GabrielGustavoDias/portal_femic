...
const AvaliadorProjetoFinal = (prop) => {
  const { project } = prop;
  ...
  const sendBarema = async (data) => {
    ...
    const projectFinalAval = 'finalista,confirmado,concluido'.includes(
      project.status
    );
          ...
          <div className="details-it">
            ...
            <form
                  ...
                  <tr>
                    ...
                    <td style={{ width: 'fit-content' }}>
                      <input
                        ...
                        min={0}
                      />
                      <span style={{ fontSize: 12, width: 300 }}>
                        0 a 10 pontos
                      </span>
                    </td>
                  </tr>
              ...
              <h1 className="!text-xl">
                Comentários em relação a avaliação conduzida e/ou Recomendações
                para aperfeiçoamento do trabalho.
              </h1>
              <span className="sub-label">
              ...
              <button
                type="submit"
                className="!w-fit rounded bg-emerald-600 my-5 text-white">
                Enviar
              </button>
            </form>
          </div>
